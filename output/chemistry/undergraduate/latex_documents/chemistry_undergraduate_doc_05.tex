...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: CH 3 F shows a 1 H NMR resonance at a similar frequency as CH 3 Cl when measured in a 12.0 T magnetic field.
\item True or False: The magnetic field responsible for the polarization of 2.5 x 10^-6 for 13 C at 298 K is 100 T.
\item True or False: Unpaired electrons are essential for both paramagnetism and ferromagnetism in materials.
\item True or False: Lead is often deemed a safe substance in aquatic environments.
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the significance of the orbital angular momentum quantum number, l, in determining the electron that is most easily removed from ground-state aluminum during ionization.
\item Discuss the factors that contribute to the difference in first ionization energy between argon and neon, and explain why argon's first ionization energy is lower.
\end{enumerate}
