...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: The van der Waals parameter a is expressed as 8.61 \ensuremath{\times} 10^\{-3\} kg $m^5$ s^\{-2\} mol^\{-2\} in SI base units.
\item True or False: One liter of paint will cover an area of 12 square meters when brushed out to a uniform thickness of 100 microns.
\item True or False: The mass of water vapor in a 400 $m^3$ room at 27^\ensuremath{\circC} and 60\% relative humidity is 8.4 kg.
\item True or False: The hydrides of group-14 elements show increasing thermal stability in the order: CH 4 \textless{} SiH 4 \textless{} GeH 4 \textless{} SnH 4 \textless{} PbH 4.
\item True or False: Sulfur dioxide (SO 2) is classified as an acid anhydride due to its ability to form sulfurous acid upon reaction with water.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Calculate the frequency of a light wave that corresponds to the wavelength equal to the Bohr radius (0.5292 \ensuremath{\times} 10^-8 cm). Discuss its significance in quantum mechanics.
\item Discuss the concept of Hermitian operators in quantum mechanics and analyze which of the following differential operators are Hermitian, providing a rationale for your conclusions.
\end{enumerate}
