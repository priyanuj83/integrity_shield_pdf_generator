...
\item True or False: The reaction of sulfuric acid with metallic calcium produces 33.6 liters of hydrogen gas at standard temperature and pressure (STP).
\item True or False: The pKa of the weak monoprotic acid can be determined directly as equal to its pH of 4.26.
\item True or False: An alcohol contains no oxygen atoms in its functional group, making it a hydrocarbon.
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Given a household cleaning solution with a hydronium ion concentration of 10^-11 M, explain how to calculate its pH and discuss whether the solution is acidic, basic, or neutral.
\item Calculate the cell potential for the reaction Ni + $Sn^2$+ → $Ni^2$+ + Sn, given the concentrations of $Ni^2$+ and $Sn^2$+. Discuss the implications for the spontaneity of the reaction.
\end{enumerate}
