...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: The ionization energy of singly ionized helium, calculated using the Bohr theory, is 48.359 eV.
...
\item True or False: Zn(NO 3)2 is expected to have a lower solubility in water than NiSO 3 due to its more complex structure.
\item True or False: The missing mass in ^19\_9 F is significantly greater than the mass of an electron, approximately 0.199 amu.
\item True or False: The molality of a solution with 49 g of H$_{2}$SO$_{4}$ in 250 g of water is 1.0 moles/kg.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Calculate the amount of water needed to dilute 5 gallons of a 90\% ammonia solution to achieve a 60\% concentration, and explain the reasoning behind your calculations.
\item Discuss the thermodynamic principles governing the expansion of one cubic foot of air when heated from 0^\ensuremath{\circC} to 546,000^\ensuremath{\circC}, and analyze the resulting change in volume.
\end{enumerate}
