...
\begin{enumerate}[label=(\alph*)]
    ...
    \item 50\%
\end{enumerate}
\item In$_{2017}$, about how many people died from terrorism globally?
\begin{enumerate}[label=(\alph*)]
    \item 260
    \item 2,600
    \item 26,000
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: It was an area of political and geographical control imposed by the Viking incursions which was formally agreed to by the Danish warlord, Guthrum and west-Saxon king, Alfred the Great in 886 AD.
\item True or False: Houston has sports teams for every major professional league except the National Hockey League (NHL). The Houston Astros are a Major League Baseball (MLB) expansion team formed in 1962 (known as the "Colt .45 s" until 1965) that made one World Series appearance in 2005.
\item True or False: These clashes, in part, contributed to the Panic of 1873 which delayed construction of the railroad into Montana. Surveys in 1874, 1875 and 1876 helped spark the Great Sioux War of 1876. The transcontinental NPR was completed on September 8, 1883, at Gold Creek.
\item True or False: Southampton Solent University has 17,000 students and its strengths are in the training, design, consultancy, research and other services undertaken for business and industry.
