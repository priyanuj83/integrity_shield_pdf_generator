...
\item True or False: Organisms living deep in the oceans around seafloor volcanic vents and in hot springs closely resemble the common ancestor of all life.
\item True or False: Venus exhibits evidence of impacts, erosion, and volcanism on its surface, highlighting its geologically active history.
\item True or False: A Mars year is approximately 2 Earth years long.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the concept of Hawking radiation and analyze its role in the theoretical evaporation of black holes over time, considering its implications for our understanding of black hole physics.
\item Discuss the significance of Betelgeuse within the constellation Orion, focusing on its characteristics, cultural impact, and its role in understanding stellar evolution.
\end{enumerate}
