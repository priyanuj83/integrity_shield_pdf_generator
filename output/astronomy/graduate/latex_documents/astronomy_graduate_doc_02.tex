...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: The craters at Mercury's poles contain the only permanently shadowed regions on the planet, suitable for preserving water-ice.
\item True or False: The Andromeda Galaxy is approximately 2.5 million light years away from Earth.
\item True or False: The truck would be harder to accelerate on Mars due to its increased weight from the stronger gravitational pull.
\item True or False: The resolution of a telescope is primarily determined by its ability to magnify distant objects.
\item True or False: The Moon's surface is less heavily cratered than the Earth's surface due to more intense geological activity.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the reasons for the compositional differences between the inner and outer planets in our solar system, focusing on the role of temperature in the condensation of materials during planet formation.
\item Discuss the concept of bolometric luminosity in astronomy, explaining its significance and how it is integrated over all wavelengths in the context of stellar observations.
\end{enumerate}
