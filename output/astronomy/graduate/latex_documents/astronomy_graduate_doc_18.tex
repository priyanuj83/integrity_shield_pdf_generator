...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: A kilogram of bricks would weigh more than five kilograms of feathers on the Moon due to the density of the materials.
...
\item True or False: Cassiopeia is a prominent W-shaped constellation located in the northern sky, easily identifiable by its distinctive shape.
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the effects on the spectral characteristics of a blackbody when its temperature is reduced to half of its original value, focusing on changes in power emitted and peak emission wavelength.
\item Discuss the significance of constellations in relation to the Milky Way, and analyze why the constellation Leo is not positioned along its plane.
\end{enumerate}
