...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: Sinnott-Armstrong primarily analyzes the ethical responsibilities of environmental entities.
\item True or False: Baxter would argue that the policy is morally unproblematic as it does not harm human beings.
\item True or False: Singer argues that the conclusions in 'All Animals Are Equal' are solely based on the principle of maximizing happiness for all sentient beings.
\item True or False: Gauthier claims that moral agreements that benefit one party over another promote a sense of community and unity.
\item True or False: According to the Ideal Moral Code theory, one is obligated to follow ideal moral rules in a world governed by majority vote.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Analyze the logical structure of the statement: "Either England's importing beef is a sufficient condition for France's subsidizing agriculture, or China doesn't promote human rights when and only when South Africa supplies diamonds." Discuss how you would symbolize this statement in propositional logic, justifying your choices.
\item Discuss the concept of moral cosmopolitanism, analyzing the obligations it imposes on individuals to assist those in need and promote basic human rights.
\end{enumerate}
