...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: Butler asserts that the only inherent right individuals possess is the right to justice.
\item True or False: Singer's principle of equality prescribes how we should treat humans with equal consideration.
\item True or False: Ashford's article focuses on the impossibility of meeting everyone's basic needs.
\item True or False: The term Guru-Panth in Sikhism specifically signifies the spiritual journey of an individual seeking enlightenment.
\item True or False: In Hobbes's view, to say something is good is to say that it is universally desired by all individuals.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss Hursthouse's perspective on the controversy surrounding the claim that an adequate moral theory must provide clear, actionable guidance for individuals.
