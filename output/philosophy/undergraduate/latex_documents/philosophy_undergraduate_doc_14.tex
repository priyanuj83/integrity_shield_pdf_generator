...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: According to Kant, a good will is the only thing that can be considered 'good' without qualification.
\item True or False: Gauthier claims that practical rationality is fundamentally based on logical justification.
\item True or False: Reiman believes that van den Haag's arguments promote human rights and ethical treatment of individuals.
\item True or False: According to Reiman, van den Haag's argument leads to the conclusion that we should institute death by torture.
\item True or False: Moral nihilism is the view that moral considerations have no relevance or application to the context of war.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss Thomson's alternative version of the violinist case, focusing on her assertion that while one ought to allow the violinist to use their kidneys for an hour, this does not imply a right to do so.
