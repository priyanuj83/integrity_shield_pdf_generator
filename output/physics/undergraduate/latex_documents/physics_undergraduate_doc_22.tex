...
\item True or False: The observer measures the meter stick passing in 1.6 ns due to its high speed of 0.8 c.
\item True or False: The electric displacement current through a surface S is proportional to the rate of change of the electric flux through S.
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item In a Michelson interferometer with a gas cell of 10 cm optical path length, 100 fringes are counted during evacuation. Calculate the original gas's index of refraction and discuss the implications of your findings.
\item Discuss the role of dopants in germanium semiconductors, specifically identifying which ions cannot be used for n-type doping and explaining the underlying reasons for their incompatibility.
\end{enumerate}
