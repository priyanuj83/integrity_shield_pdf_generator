...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: Grade 2/5 power represents movement of the arm only against gravity.
\item True or False: A higher level of education is linked to an increased risk of Alzheimer's disease in older adults.
\item True or False: The temporal bone has a process that articulates with the zygomatic bone to form the zygomatic arch.
\item True or False: Type I muscle fibers are characterized as red, oxidative, and slow contracting, primarily used for endurance activities.
\item True or False: The concentration of a substance in food is a critical factor in assessing its safety for human consumption.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the genetic basis of DiGeorge/Shprintzen syndrome, focusing on the implications of the chromosomal deletion involved and its effects on health and development.
\item Discuss the role of ubiquitin in proteolysis, specifically addressing its attachment to proteins designated for synthesis versus catabolism and the implications for cellular regulation.
\end{enumerate}
