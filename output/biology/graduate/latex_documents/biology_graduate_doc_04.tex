...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the challenges of using human subjects in inheritance studies, focusing on genetic complexity, environmental factors, ethical considerations, and demographic limitations.
