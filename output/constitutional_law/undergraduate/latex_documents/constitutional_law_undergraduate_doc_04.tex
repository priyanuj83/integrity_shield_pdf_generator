...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: Robert Nozick's formula r x H represents the extent of responsibility multiplied by actual harm done in determining punishment.
\item True or False: Hume's critique of natural law is based on the idea that moral truths cannot be known objectively.
\item True or False: An 'armed attack' gives the right to invade any State regardless of the level of force used.
...
\item True or False: The UN Human Rights Committee is a treaty-based mechanism responsible for monitoring the implementation of human rights treaties.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss how Durkheim's perspective on the function of punishment reflects the concept of vengeance within the framework of constitutional law. Analyze its implications for modern legal systems.
\item Discuss the reasons John Finnis provides for rejecting Hume's conception of practical reason, particularly in relation to how human reason can define a worthwhile life.
\end{enumerate}
