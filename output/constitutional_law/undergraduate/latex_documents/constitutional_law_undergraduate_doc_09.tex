...
\item True or False: In Hohfeld's scheme, the relationship of power and liability is considered a contradiction in jural relations.
\item True or False: Salmond defined law as a set of principles or rules recognized and applied by the State in administering justice.
\item True or False: Dworkin measures equality of resources solely by the amount of income tax paid by individuals in society.
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the nature of the UK Constitution, emphasizing its uncodified status and the various sources from which it is derived. Analyze the implications of this structure on governance and law.
\item Discuss the relationship between Durkheim's concepts of mechanical and organic solidarity and their respective influences on the types of law present in society.
\end{enumerate}
