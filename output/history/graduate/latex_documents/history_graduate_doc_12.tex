...
\item True or False: Its knowledge and uses spread from China through the Middle East to medieval Europe in the 13 th century, where the first water powered paper mills were built. Because of paper's introduction to the West through the city of Baghdad, it was first called bagdatikos. In the a different answer century, industrial manufacture greatly lowered its cost, enabling mass exchange of information and contributing to significant cultural shifts.
\item True or False: a different answer represent the bulk of modern Jewry, with at least 70\% of Jews worldwide (and up to 90\% prior to World War II and the Holocaust).
\item True or False: The army was still equipped with the Dreyse needle gun of Battle of Königgrätz fame, which was by this time showing the age of its 25-year-old design.
