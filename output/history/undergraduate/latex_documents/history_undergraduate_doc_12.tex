...
\item By$_{1900}$B.P., the central elements of Mayan culture were in place. These did NOT include:
...
\item True or False: Some Presbyterian traditions adopt only the a different answer as the doctrinal standard to which teaching elders are required to subscribe, in contrast to the Larger and Shorter catechisms, which are approved for use in instruction.
\item True or False: Elsewhere, remnants of the medieval water supply system devised by the friars can still be seen today. Constructed in 1410, the system carried water from Conduit Head (remnants of which survive near Hill Lane, Shirley) some 1.
