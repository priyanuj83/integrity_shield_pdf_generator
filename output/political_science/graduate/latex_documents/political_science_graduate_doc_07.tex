...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: China is classified alongside nonstate actors such as terrorists and drug traffickers in terms of threats to U.S. national security.
\item True or False: American exceptionalism promotes the liberalization of global trade, reflecting a commitment to free market principles.
\item True or False: During the presidencies of George H.W. Bush and Bill Clinton, the influence of Congress over foreign policy significantly increased.
\item True or False: Ideational approaches to US foreign policy during the Cold War emphasize ideology and beliefs more than material interests and power.
\item True or False: Regime type is not a reliable predictor of which states will pursue nuclear weapons.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the factors that led to the institutional innovation of security studies, focusing on the impact of broader political considerations on strategic long-term mobilization.
