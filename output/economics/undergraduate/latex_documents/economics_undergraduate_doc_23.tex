...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: Theo's job loss due to seasonal pool closure exemplifies natural unemployment, reflecting unavoidable fluctuations in the labor market.
\item True or False: Workers' productivity decreases as they receive higher wages, leading firms to raise wage rates in a competitive market.
...
\item True or False: The coefficient estimates in VARs are always positive, reflecting the nature of relationships among the variables.
\item True or False: Demand for a good with many close substitutes tends to be highly elastic due to the availability of alternatives.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the impact of multicollinearity on the properties of the Ordinary Least Squares (OLS) estimator, focusing on its bias and efficiency.
\item Discuss the characteristics of a kinked demand curve in oligopoly markets and explain why the condition P \textless{} MC does not align with its fundamental principles.
\end{enumerate}
