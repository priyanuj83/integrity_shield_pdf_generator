...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: The fitted regression line can be represented as ̂y\_t = ̂α + ̂βx\_$t^2$ + ̂u\_t.
\item True or False: A monopoly with a straight, downward-sloping demand curve has a marginal revenue curve that is initially downward sloping.
\item True or False: The fixed effects panel model is also known as the random effects model in econometric analysis.
\item True or False: A decrease in the cost of labor for bookbinding will shift the supply curve for textbooks to the left.
\item True or False: A nation producing inside its production possibility curve indicates a permanent decrease in its production capacity.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the implications of a wage rate of \$4.50 on labor hiring decisions in a market economy. How would you determine the number of labor units hired at this wage?
\item Discuss the disadvantages of using pure time-series models in economic analysis, particularly in terms of their lack of theoretical motivation compared to structural models.
\end{enumerate}
