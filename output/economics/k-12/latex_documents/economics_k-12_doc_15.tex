...
\item True or False: Air provides both the largest total utility and the smallest marginal utility due to its essential and abundant nature.
\item True or False: The Federal Reserve uses changing tariffs and quotas as a primary method to influence the economy.
\item True or False: An increase in aggregate demand results in a decrease in both unemployment and inflation rates.
\item True or False: National income measures the total household income across all families in the nation without considering production factors.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the role of firms and households in the circular flow model of a private closed economy, focusing on how goods and revenues are exchanged between them.
\item Discuss how the introduction of a new production technique that lowers costs can influence economic growth. Provide examples to support your analysis.
\end{enumerate}
