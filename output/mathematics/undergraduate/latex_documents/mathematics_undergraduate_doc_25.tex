...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: There is only one additive abelian group of order 16 that satisfies the condition x + x + x + x = 0 for all x in the group.
\item True or False: The maximum possible order for an element of S\_6 is 12.
\item True or False: The complex numbers under addition form a group, including the zero element as the identity.
\item True or False: The norm ||x||\_p can be expressed as an inner product only for p = 2.
