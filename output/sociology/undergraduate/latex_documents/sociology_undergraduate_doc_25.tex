...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: The 'correspondence principle' posits that schools prepare children for the workforce by instilling obedience and conformity.
\item True or False: Telework is a form of employment that involves working from home for an outside employer, utilizing information technology.
\item True or False: A population pyramid with a higher birth rate than death rate typically appears wider at the bottom than at the top.
\item True or False: The concept of 'power elite' describes the ruling class that exploits the proletariat in a capitalist society.
\item True or False: Cultural restructuring exclusively focuses on preserving traditional landscapes without any economic transformation.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the findings of Sullivan's (2000) study on the dynamics of housework distribution among men, particularly in relation to their employment status and that of their partners.
\item Discuss the decision-making processes identified by Domhoff in the context of American society, and critically analyze why he excludes the exploitation process from his framework.
\end{enumerate}
