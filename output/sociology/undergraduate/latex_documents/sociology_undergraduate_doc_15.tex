...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: Eyeballing is a technique that requires keeping your eyes on research participants at all times.
\item True or False: Terrorism is primarily a local issue, unrelated to international relations or political conflicts.
\item True or False: The demographic transition is characterized by a decline in birth rates, increased life expectancy, and an ageing population.
\item True or False: Impersonal rules are a core characteristic of Weber's ideal type of bureaucracy.
\item True or False: Marx argued that religion would vanish when church attendance fell below a certain percentage, such as 15\%.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the process of socialization, examining its significance in shaping individual identity and facilitating membership within society.
\item Discuss the concept of vertical mobility in sociology, analyzing its implications for social structure and individual identity within society.
\end{enumerate}
