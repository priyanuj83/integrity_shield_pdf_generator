...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: Dahrendorf, Rex, and Habermas concentrated on the dynamics of power, domination, and conflict within social structures.
\item True or False: Weber argued that all sociological theories are evaluated based solely on their empirical validity, independent of any values.
\item True or False: Cultural restructuring encompasses regenerating economically declined cities, transforming industrial areas into tourist spots, and utilizing media advertising.
\item True or False: Lombroso claimed that biological failings were a primary factor driving some individuals to commit crimes.
\item True or False: Women pursue cosmetic surgery primarily due to pressure from male partners to conform to supermodel standards.
\end{enumerate}
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss Marx's assertion that religion would diminish following a socialist revolution, analyzing the relationship between capitalist ideology and religious belief in this context.
\item Discuss the characteristics of totalitarian societies, emphasizing the role of citizen freedoms such as movement. How do these elements define the nature of totalitarianism?
\end{enumerate}
