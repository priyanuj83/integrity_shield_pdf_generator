...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{5}
\item True or False: Thatcher's government actively aimed to enhance financial support for single parents, students, and the unemployed.
\item True or False: Chodorow (1978) argued that both boys and girls are closely attached to their mothers, but boys later break away from this attachment.
\item True or False: Researchers are prohibited from accessing official statistics on domestic violence, limiting their ability to study the issue.
\item True or False: Decarceration primarily emphasizes the increased use of imprisonment as the predominant form of punishment.
...
\begin{enumerate}[label=\arabic*.]
\setcounter{enumi}{10}
\item Discuss the concept of community in sociology by analyzing various forms, and critically evaluate why sociological communities formed by unpopular lecturers may not be considered a new form of community.
\item Discuss Émile Durkheim's concept of social facts and explain why he believed they should be the primary focus of sociology. Analyze their significance in understanding societal structures.
\end{enumerate}
